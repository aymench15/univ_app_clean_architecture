...
import 'package:movie_app_with_two_modules/movies/data/datasource/movie_datasource.dart';
...
void main() async {
  ...
  DomainRepository dimainRepository = DataMovieRepository(movieRemoteData);
  //Movie movie = (await PlayingNowMovies(dimainRepository).execute()) as Movie;
  print((await PlayingNowMovies(dimainRepository).execute()));
